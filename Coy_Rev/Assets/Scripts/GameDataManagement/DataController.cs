...
public class DataController : MonoBehaviour
{
    ...
    public class GameData
    {
        ...
        public string[] roles;  //캐릭터의 role 저장
        public int[] TMIcount;
        public int KYCount5;
        public int KYCount10;
        public int SJCount5;
        public int SJCount10;
        public int[] Ans5Count;
        public int[] LoveCount;

        public List<int> CharList = new List<int>(); // 하루에 캐릭터 2명씩 뜨도록 하는 용도
        public List<int> temp = new List<int>(); //재시작할 때 중간 저장용

        public int[] QTimes; //말 건 횟수 저장
        public Queue<int> CutSceneQueue = new Queue<int>();
